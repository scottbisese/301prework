...
// localecompare compares two strings figured this out courtesty of clownvin: if first string comes before the compare string or whats in parenthese, then it returns a -1, if equal a 0, if after a 1.
/*------------------------------------------------------------------------------------------------
CHALLENGE 8
