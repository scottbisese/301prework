...
const validateEmail = (email) => email.match(/^[\d\w]+(\.[\d\w]+)?@[\d\w]+\.((com)|(net)|(org))$/);
                                //beginning and end are ^ and $. [\d\w]+ is one or more digit or letter.
                               // ? is 0 or 1, meaning optional. everything in ()? being optional. so after the escaping the period with 
                               // \ you can optionally have one or more digits or letters. Then an at sign @ followed by phrase and . 
                               //followed by either com or net or org. end regex.
